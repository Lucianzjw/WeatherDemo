package com.example.weatherdemo.view.magicindicator.buildins.commonnavigator.indicators;
...
import com.example.weatherdemo.view.magicindicator.FragmentContainerHelper;
...
import com.example.weatherdemo.view.magicindicator.buildins.commonnavigator.model.PositionData;

import java.util.Arrays;
import java.util.List;

/**
 * 直线viewpager指示器，底线渐变色
 * 博客: http://hackware.lucode.net
 * Created by hackware on 2016/6/26.
 */
public class BHLinePagerIndicator extends View implements IPagerIndicator {
...
//        }
        ...
        //渐变色
//        int startColor = Color.parseColor("#02A0B7");
//        int centerColor = Color.parseColor("#02A0B7");
//        int endColor = Color.parseColor("#45DEDE");
        if (mColors != null) {
            if (mColors.size() > 2) {
                mPaint.setShader(new LinearGradient(0, 0, mLineRect.right, 0,
                        new int[]{mColors.get(0), mColors.get(1), mColors.get(2)},
                        new float[]{0f, 0.5f, 1.0f},
                        Shader.TileMode.CLAMP));
            } else {
                mPaint.setShader(new LinearGradient(0, 0, mLineRect.right, 0,
                        new int[]{mColors.get(0), mColors.get(0), mColors.get(0)},
                        new float[]{0f, 0.5f, 1.0f},
                        Shader.TileMode.CLAMP));
            }
        }
        ...
        mLineRect.bottom = (getHeight() - mYOffset) + 20;
